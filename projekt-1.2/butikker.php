...
<?php
	...
	"Herremode" => array(
		"!Solid" => array(
			...
			"kort" => "<a href='kort.php'>Findes på plan 5</a>",
			"logo" => "<a href='images/logoer/solid_logo.png'"
			),
		"Bertoni" => array(
			"telefon" => "87 55 55 60",
			"web" => "<a href='http://www.bertoni.dk/' target='_blank'>www.bertoni.dk</a>",
			"kort" => "<a href='kort.php'>Findes på plan 5</a>",
			"logo" => "<a href='images/logoer/bertoni_logo.png'"
			),
		"Boxer" => array(
			"telefon" => "86 18 20 00",
			"web" => "<a href='http://www.boxer.dk/' target='_blank'>www.boxer.dk</a>",
		...
		"Jack & Jones" => array(
			...
			"kort" => "<a href='kort.php'>Findes på plan 5</a>",
			"logo" => "<a href='images/logoer/jackandjones_logo.png'"
			),
		"Juel & Jessen" => array(
			"telefon" => "86 76 56 50",
			"web" => "",
		...
		"Marcus" => array(
			...
			"kort" => "<a href='kort.php'>Findes på plan 5</a>",
			"logo" => "<a href='images/logoer/marcus_logo.png'"
			),
		"Mr Hannesbo" => array(
			"telefon" => "86 13 73 03",
			"web" => "<a href='http://www.mr.dk/aarhus-brabrand' target='_blank'>www.mr.dk/aarhus-brabrand</a>",
		...
		"qUINT" => array(
			...
			"kort" => "<a href='kort.php'>Findes på plan 5</a>",
			"logo" => "<a href='images/logoer/quint_logo.png'"
			),
		"Samsøe & Samsøe" => array(
			"telefon" => "86 25 11 18",
			"web" => "<a href='http://www.samsoesamsoe.dk' target='_blank'>www.samsoesamsoe.dk</a>",
	...
	"Teen & Børn" => array(
		"Accessorize" => array(
			...
			"kort" => "<a href='kort.php'>Findes på plan 4</a>",
			"logo" => "<a href='images/logoer/accessorize_logo.png'"
			),
		"Bahne" => array(
			"telefon" => "38 40 50 11",
			"web" => "<a href='http://www.bahne.dk/' target='_blank'>www.bahne.dk</a>",
		...
		"Build A Bear" => array(
			...
			"kort" => "<a href='kort.php'>Findes på plan 4</a>",
			"logo" => "<a href='images/logoer/babw_logo.png'"
			),
		"Fætter BR" => array(
			"telefon" => "35 46 21 89",
			"web" => "<a href='http://www.br-leg.dk/' target='_blank'>www.br-leg.dk</a>",
			"kort" => "<a href='kort.php'>Findes på plan 4</a>",
			"logo" => "<a href='images/logoer/br_logo.png'"
			),
		"H&M" => array(
			"telefon" => "70 10 23 31",
			"web" => "<a href='http://www.hm.com/' target='_blank'>www.hm.com</a>",
	...
	"Sko" => array(
		"Bianco Footwear" => array(
			...
			"kort" => "<a href='kort.php'>Findes på plan 5</a>",
			"logo" => "<a href='images/logoer/bianco_logo.png'"
			),
		"Blitz" => array(
			"telefon" => "32 19 50 50",
			"web" => "",
		...
		"Deichmann" => array(
			...
			"kort" => "<a href='kort.php'>Findes på plan 4</a>",
			"logo" => "<a href='images/logoer/deichmann_logo.png'"
			),
		"Dope" => array(
			"telefon" => "86 12 25 70",
			"web" => "<a href='http://www.dope.dk' target='_blank'>www.dope.dk</a>",
			"kort" => "<a href='kort.php'>Findes på plan 5</a>",
			"logo" => "<a href='images/logoer/dope_logo.png'"
			),
		"Foot Locker" => array(
			"telefon" => "86 17 98 90",
			"web" => "<a href='http://www.footlocker-europe.com' target='_blank'>www.footlocker-europe.com</a>",
			"kort" => "<a href='kort.php'>Findes på plan 5</a>",
			"logo" => "<a href='images/logoer/footlocker_logo.png'"
			),
		"Maibom-Euro Walk" => array(
			"telefon" => "86 25 29 00",
			"web" => "",
			"kort" => "<a href='kort.php'>Findes på plan 5</a>",
			"logo" => "<a href='images/logoer/maibom_logo.png'"
			),
		"Posh Shoes" => array(
			"telefon" => "86 24 54 00",
			"web" => "",
			"kort" => "<a href='kort.php'>Findes på plan 4</a>",
			"logo" => "<a href='images/logoer/poshshoes_logo.png'"
			),
		)
	);
	$butikker = array(
	"Modetilbehør & Personlig pleje" => array(
		...
		"Body Shop" => array(
			...
			"kort" => "<a href='kort.php'>Findes på plan 4</a>",
			"logo" => "<a href='images/logoer/bodyshop_logo.png'"
			),
		...
		"Erfurt accessories" => array(
			...
			"kort" => "<a href='kort.php'>Findes på plan 4</a>",
			"logo" => "<a href='images/logoer/erfurt_logo.png'"
			),
		"Glitter" => array(
			"telefon" => "86 13 14 64",
			"web" => "<a href='http://www.glitter.dk' target='_blank'>www.glitter.dk</a>",
			"kort" => "<a href='kort.php'>Findes på plan 5</a>",
			"logo" => "<a href='images/logoer/glitter_logo.png'"
			),
		"Hunkemöller" => array(
			"telefon" => "51 85 39 09",
			"web" => "<a href='http://www.hunkemoller.com/' target='_blank'>www.hunkemoller.com</a>",
	...
	"Radio, TV & Elektronik" => array(
		"3 Mobil" => array(
			...
			"kort" => "<a href='kort.php'>Findes på plan 4</a>",
			"logo" => "<a href='images/logoer/3_logo.png'"
			),
		"Expert" => array(
			"telefon" => "70 23 79 23",
			"web" => "<a href='http://www.expert.dk' target='_blank'>www.expert.dk</a>",
			"kort" => "<a href='kort.php'>Findes på plan 4</a>",
			"logo" => "<a href='images/logoer/expert_logo.png'"
			),
		"Game Stop" => array(
			"telefon" => "87 48 60 60",
			"web" => "<a href='http://www.gamestop.dk' target='_blank'>www.gamestop.dk</a>",
			"kort" => "<a href='kort.php'>Findes på plan 4</a>",
			"logo" => "<a href='images/logoer/gamestop_logo.png'"
			),
		"Stereo Studio" => array(
			"telefon" => "86 18 90 70",
			"web" => "<a href='http://www.sterostudio.dk' target='_blank'>www.sterostudio.dk</a>",
			"kort" => "<a href='kort.php'>Findes på plan 4</a>",
			"logo" => "<a href='images/logoer/SS_logo.png'"
			),
		"TDC" => array(
			"telefon" => "86 19 20 26",
			"web" => "",
			"kort" => "<a href='kort.php'>Findes på plan 4</a>",
			"logo" => "<a href='images/logoer/tdc_logo.png'"
			),
		"Telenor" => array(
			"telefon" => "60 50 42 32",
			"web" => "",
			"kort" => "<a href='kort.php'>Findes på plan 4</a>",
			"logo" => "<a href='images/logoer/telenor_logo.png'"
			),
		)
	);
	$butikker = array(
	"Dagligvarer" => array(
		...
		"Kvickly" => array(
			...
			"kort" => "<a href='kort.php'>Findes på plan 4</a>",
			"logo" => "<a href='images/logoer/kvickly_logo.png'"
			),
		"Summerbird" => array(
			"telefon" => "86 19 00 80",
			"web" => "<a href='http://www.summerbird.dk/' target='_blank'>www.summerbird.dk</a>",
	...
	"Restaurant & Café" => array(
		"Baresso Coffee" => array(
			...
			"web" => "",
			"kort" => "<a href='kort.php'>Findes på plan 4</a>",
			"logo" => "<a href='images/logoer/baresso_logo.png'"
			),
		"Den Græske Delikatesse" => array(
			"telefon" => "86 17 61 55",
			"web" => "",
		...
		"JOE & THE JUICE" => array(
			...
			"kort" => "<a href='kort.php'>Findes på plan 4</a>",
			"logo" => "<a href='images/logoer/joethejuice_logo.png'"
			),
		"Juicemania" => array(
			"telefon" => "40 50 08 01",
			"web" => "",
		...
		"Kong Kaffe" => array(
			...
			"web" => "",
			"kort" => "<a href='kort.php'>Findes på plan 4</a>",
			"logo" => "<a href='images/logoer/kongkaffe_logo.png'"
			),
		"Kong Kaffe express" => array(
			"telefon" => "87 46 07 34",
			"web" => "",
			"kort" => "<a href='kort.php'>Findes på plan 4</a>",
			"logo" => "<a href='images/logoer/kke_logo.png'"
			),
		"Kong Venience" => array(
			"telefon" => "87 46 07 34",
			"web" => "",
		...
		"Sunset Boulevard" => array(
			...
			"kort" => "<a href='kort.php'>Findes på plan 4</a>",
			"logo" => "<a href='images/logoer/sunset_logo.png'"
			),
		)
	);
	$butikker = array(
	"Cinemaxx" => array(
		"Cinemaxx" => array(
			...
			"logo" => "<a href='images/logoer/Cinemaxx_Logo.png'"
			),
		)
	);
